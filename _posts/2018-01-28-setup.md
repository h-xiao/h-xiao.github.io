...
This YahooFinancials package allows us to get the last 4 quarterly financial statement  in or the last 3 annual financial statement data. The raw output is in a json format which we will adjust to a df format using the get_fundamental_data function. 
